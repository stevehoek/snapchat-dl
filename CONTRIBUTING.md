...
Report bugs [here](https://github.com/stevehoek/snapchat-dl/issues).
...
The best way to send feedback is to file an issue  [here](https://github.com/stevehoek/snapchat-dl/issues).
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/stevehoek/snapchat-dl/pull_requests
